...
;
    Polymer({
        ...
        process: function () {
            if (this.date) 
                if(this.date*1==this.date) var t = new Date(this.date);
                else var t = new Date(Date.parse(this.date));
            else var t = new Date();
            this.$.format.innerHTML = t.format(this.format);
        },
    });
...
;
    Polymer({
        ...
        attached: function(){
            DATA.ready(function(){
                this.set('months',DATA.getMonths('videos'));
            }.bind(this));
        },
        getMonth: function(month){
            return DATA.getMonth('videos',month);
        }
    });
...
;
    Polymer({
        ...
        attached: function(){
            DATA.ready(function(){
                this.set('months',DATA.getMonths('shopping'));
            }.bind(this));
        },
        getMonth: function(month){
            return DATA.getMonth('shopping',month);
        }
    });
...
;
    Polymer({
        ...
        ready: function(){
            DATA.ready(function(){
                this.set('months',DATA.getMonths('people'));
            }.bind(this));
        },
        getMonth: function(month){
            return DATA.getMonth('people',month);
        }
    });
